...
public class UserFinancialsPlanController {
    ...
    public ReturnClass createFinancialPlan(Authentication authentication) throws Exception {
        ...
        String content = "사용자의 자산 현황: \n" +
                ...
                "각 필드에 대한 설명:\n" +
                "- 지출_조정.월_지출: 월 소득 대비 권장 지출 비율을 0에서 100 사이의 정수로 제시합니다 (예: 60은 60%를 의미).\n" +
                ...
                "주의사항: 모든 설명과 조언은 명사형으로 작성해주세요. 예를 들어, \"주택 담보 대출의 높은 이자율을 고려해 가장 우선적으로 추가 상환하는 것이 좋음\"과 같은 형식으로 작성해 주세요.";
